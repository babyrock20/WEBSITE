        ...
        <?php include('message.php');?>
            <div class="card">
                <div class="card-header">
                    <h4>Edit program
                        <a href="non_exec-view.php" class="btn btn-danger float-end">BACK</a>
                    </h4>
                </div>
            <div class="card-body">
                <?php
                    $point_id = $_GET['S_No'];
                    $edit_query= "SELECT * FROM non_exec WHERE S_No='$point_id';";
                       ...
                       ?>
                        <form action="allcode.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <button type="submit"  name="edit-non_exec" class="btn btn-primary">Confirm</button>
                                </div>
